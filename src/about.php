...
<head>
    ...
    <title>About | A University Event Management System</title>
...
<body class="website-body">
    ...
    <main class="site-shell page-main">
        <section class="page-title">
            ...
            <h1>A role-based website for managing university events from announcement to approval.</h1>
            <p class="muted">The system is designed for students, event administrators, and university coordinators who need a simple digital workflow.</p>
        </section>
        ...
        <section class="panel-grid">
            <article class="panel">
                ...
                <div class="timeline-list">
                    ...
                    <div>
                        <strong>2. Student Registration</strong>
                        <span>Students create accounts, browse events, search categories, and request seats.</span>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <span>Reports show category performance, seat usage, pending requests, and active students.</span>
                    </div>
                </div>
            </article>
            ...
            <article class="panel">
                ...
                <div class="feature-list">
                    ...
                    <span>Student registration and login</span>
                    <span>Student dashboard and My Events page</span>
